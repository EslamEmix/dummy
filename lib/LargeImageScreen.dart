...
class LargeImageScreen extends StatefulWidget {
  const LargeImageScreen({Key key, this.title}) : super(key: key);

  final String title;

  @override
  LargeImageScreenState createState() => LargeImageScreenState();
}

class LargeImageScreenState extends State<LargeImageScreen>
...
class SecondScreen extends LargeImageScreen {}
